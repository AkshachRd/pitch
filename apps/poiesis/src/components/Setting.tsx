'use client';
import { useLayoutEffect, useState, useCallback, useMemo, type ReactNode, useEffect } from 'react';
            ...
            <TooltipProvider delayDuration={100}>
                <Tooltip open={open} onOpenChange={(opened) => setOpen(opened)}>
                    <TooltipTrigger asChild>
                        <CircleHelp
                            className="ml-1 h-4 w-4 cursor-help opacity-50 max-sm:ml-0"
                            onClick={(ev) => {
                                ev.preventDefault();
                                ev.stopPropagation();
                                handleOpen();
    ...
    return (
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-w-md print:hidden">
                                            ...
                                            <FormItem className="from-item">
                                                ...
                                                <FormControl className="col-span-3">
                                                    <Password
                                                        type="text"
                                                        placeholder={t(
                                                            'setting.accessPasswordPlaceholder',
                                                        )}
                                                            ...
                                                            <SelectContent className="max-sm:max-h-72">
                                                                {thinkingModelList[0].length > 0 ? (
                                                                    <SelectGroup>
                                                                        <SelectLabel>
                                                                            {t(
                                                                                'setting.recommendedModels',
                                                                            )}
                                                                        </SelectLabel>
                                                                        {thinkingModelList[0].map(
                                                                            (name) => {
                                                                                return !isDisabledAIModel(
                                                                                    name,
                                                                                ) ? (
                                                                                    <SelectItem
                                                                                        key={name}
                                                ...
                                                <FormItem className="from-item">
                                                    ...
                                                    <FormControl className="col-span-3">
                                                        <Password
                                                            type="text"
                                                            placeholder={t(
                                                                'setting.searchApiKeyPlaceholder',
                                                            )}
                                                            disabled={
                                                                form.getValues('enableSearch') ===
                                                                '0'
                                                            }
                                                            {...field}
                                                        />
                ...
                <DialogFooter className="mt-2 flex-row gap-3 sm:justify-between sm:space-x-0">
