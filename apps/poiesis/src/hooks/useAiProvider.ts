        ...
        switch (provider) {
            ...
            case 'anthropic':
                ...
                const anthropic = createAnthropic(
                    mode === 'local'
                        ? {
                              baseURL: completePath(anthropicApiProxy || ANTHROPIC_BASE_URL, '/v1'),
                              apiKey: anthropicKey,
                              headers: {
                                  // Avoid cors error
            ...
            case 'deepseek':
                ...
                const deepseek = createDeepSeek(
                    mode === 'local'
                        ? {
                              baseURL: completePath(deepseekApiProxy || DEEPSEEK_BASE_URL, '/v1'),
                              apiKey: deepseekKey,
                          }
                        : {
            ...
            case 'ollama':
                ...
                if (mode === 'proxy') ollamaHeaders['Authorization'] = `Bearer ${accessKey}`;
